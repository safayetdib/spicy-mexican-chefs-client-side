			...
			<section className="mx-auto bg-red-100 p-5 text-gray-100 sm:p-10 md:p-16">
				<div className="mx-auto flex max-w-7xl flex-col items-center justify-center overflow-hidden rounded">
					<img
						...
						alt=""
						className="h-60 w-full bg-gray-500 object-cover object-bottom sm:h-[400px]"
					/>
					<div className="m-4 mx-auto -mt-2 space-y-6 bg-red-accent p-6 pb-12 sm:mx-12 sm:-mt-24 sm:px-10 lg:max-w-5xl lg:rounded-md">
						<div className="space-y-2">
							<a
								rel="noopener noreferrer"
								href="#"
								className="inline-block text-3xl font-semibold text-gray-50 sm:text-4xl">
				...
				<div className="mx-auto mt-6 max-w-5xl space-y-4 text-justify text-base text-gray-700 sm:px-20 lg:px-10">
					<p>
