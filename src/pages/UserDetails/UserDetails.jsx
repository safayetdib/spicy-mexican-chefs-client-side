...
const UserDetails = () => {
	...
	return (
		<div className="flex min-h-[56vh] items-center justify-center">
			<div className="text-gray-1\700 mx-auto flex max-w-xs flex-col justify-center rounded-xl bg-gray-100 p-6 shadow-md sm:px-12">
				<img
					src={
						user && user.photoURL
							? user.photoURL
				...
				<div className="space-y-4 divide-y divide-gray-700 text-center">
					...
					<div className="align-center flex justify-center space-x-4 pt-2">
						<a
							...
							href="#"
							aria-label="GitHub"
							className="rounded-md p-2 text-gray-600 hover:text-violet-400">
							<svg
								viewBox="0 0 496 512"
