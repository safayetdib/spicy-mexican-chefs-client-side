	...
	return (
		<footer className="mx-auto max-w-screen-xl bg-white px-4 py-5 text-sm font-medium text-gray-600 md:px-8">
			<div className="max-w-lg sm:mx-auto sm:text-center">
				...
				<Link
					to="/"
					className="flex items-center gap-2 font-caveat text-2xl text-red-accent hover:text-red-hover sm:justify-center sm:text-3xl">
					<GiChefToque />
					<span>Spicy Mexican Chefs</span>
				</Link>
				<p className="mt-2 font-caveat text-xl leading-relaxed">
					Embark on a culinary adventure with Spicy Mexican Chefs authentic
					Mexican recipes, curated by our expert chefs
				</p>
			</div>
			{/* NAVIGATION */}
			<ul className="mt-8 items-center justify-center space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
				{navigation.map((item, idx) => (
					<li key={idx} className="hover:text-red-hover">
			...
			<div className="mt-8 items-center justify-between sm:flex">
				<div className="mt-6 sm:mt-0">
					...
					<ul className="flex items-center space-x-4">
						<li className="flex h-10 w-10 items-center justify-center rounded-full border hover:border-red-hover">
							<Link to="/">
								<svg
				...
				<div className="mt-6 sm:mt-0">
					&copy; 2023 Spicy_Mexican_Chefs All rights reserved.
				</div>
			</div>
			<style>{`
				.svg-icon path,
